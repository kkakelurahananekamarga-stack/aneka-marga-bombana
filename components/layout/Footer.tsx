        ...
        <footer className="bg-desa-800 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
                ...
                <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {/* Menu Cepat */}
                    <div>
                        <h3 className="font-semibold text-desa-100 mb-3 text-sm">Menu Cepat</h3>
                    ...
                    {/* Sosial */}
                    <div>
                        <h3 className="font-semibold text-desa-100 mb-3 text-sm">Ikuti Kami</h3>
                ...
                <div className="sm:hidden">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <a href="#" aria-label="Instagram" className="w-8 h-8 bg-desa-700 rounded-lg flex items-center justify-center">
                            ...
                            <a href="#" aria-label="YouTube" className="w-8 h-8 bg-desa-700 rounded-lg flex items-center justify-center">
                    ...
                    {/* Menu — 4 kolom compact */}
                    <div className="grid grid-cols-4 gap-1 mb-4">
                        {menuLinks.map((link) => (
                            <Link
                                key={link.href}
                                href={link.href}
                                className="text-desa-300 hover:text-white text-xs text-center py-1 transition-colors"
                            >
                                {link.label}
                            </Link>
                        ))}
