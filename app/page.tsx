...
export const metadata: Metadata = {
    title: 'Kelurahan Aneka Marga — Kecamatan Rarowatu Utara, Kabupaten Bombana',
    description:
        'Selamat datang di website resmi Kelurahan Aneka Marga. Temukan informasi profil kelurahan, pemerintahan, potensi, UMKM, layanan, berita, dan galeri.',
    openGraph: {
        title: 'Kelurahan Aneka Marga',
        description: 'Website resmi Kelurahan Aneka Marga, Kecamatan Rarowatu Utara, Kabupaten Bombana.',
...
const navMenu = [
    {
        ...
        description: 'Sejarah, visi, misi, dan informasi geografis kelurahan',
        icon: (
    ...
    },
    {
        href: '/pemerintahan',
        label: 'Pemerintahan',
        description: 'Struktur organisasi dan perangkat kelurahan',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    {
        href: '/potensi',
        label: 'Potensi Kelurahan',
        description: 'Sumber daya alam dan ekonomi kelurahan',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    },
    {
        href: '/umkm',
        label: 'UMKM',
        description: 'Usaha mikro, kecil, dan menengah warga kelurahan',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    },
    {
        href: '/berita',
        label: 'Berita',
        description: 'Informasi dan kegiatan terbaru kelurahan',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    },
    {
        href: '/kontak',
        label: 'Kontak',
        description: 'Informasi kontak dan lokasi kantor kelurahan',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
const placeholderProfile: Omit<Profile, 'id'> = {
    sejarah: 'Kelurahan Aneka Marga adalah kelurahan yang terletak di Kecamatan Rarowatu Utara, Kabupaten Bombana, Sulawesi Tenggara.',
    visi: 'Terwujudnya Kelurahan Aneka Marga yang maju, mandiri, dan sejahtera.',
    misi: 'Meningkatkan pelayanan kepada masyarakat dan mengembangkan potensi kelurahan.',
            ...
            <section className="py-10 sm:py-12 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">
                        Tentang Kelurahan Aneka Marga
                    </h2>
                    <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
                        {displayProfile.sejarah
                            ? displayProfile.sejarah.slice(0, 300) + (displayProfile.sejarah.length > 300 ? '...' : '')
                            : 'Kelurahan Aneka Marga adalah kelurahan yang terletak di Kecamatan Rarowatu Utara, Kabupaten Bombana, Sulawesi Tenggara.'}
                    </p>
            ...
            <section className="py-10 sm:py-12 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-xl sm:text-3xl font-bold text-gray-800 text-center mb-2">
                        Jelajahi Kelurahan Aneka Marga
                    </h2>
                    <p className="text-gray-500 text-center text-sm mb-6 sm:mb-8">Temukan berbagai informasi kelurahan melalui menu di bawah ini</p>
